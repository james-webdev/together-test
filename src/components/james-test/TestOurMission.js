		...
		<>
			<div className="relative mb-44 flex justify-center">
				<div className="flex max-w-4xl flex-col">
					<p className="mt-14 max-w-2xl font-display text-2xl">Our mission</p>
					...
					<button className="mt-8 font-light font-bold flex w-32 min-w-fit gap-3 text-start text-xl">
						Learn More
						<RightArrow />
					</button>
				</div>
